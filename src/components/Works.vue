    ...
    return {
      workList: [
        ...
        },
        {
          ...
          description: '※凍結されていたので、後日他の場所に移します。職業訓練時に作成したサイトです。架空の人物を見立てて、作成したものになります。',
          detailedDescription: '※凍結されていたので、後日他の場所に移します。架空の人物を見立てて、作成したものです。この架空人物の作品はすべてライセンスフリーのものを載せています。レスポンシブ対応をしておりますが、こちらもappleの製品が手元にないので、iOS、safariでの確認はできておりません。',
          date: '2017-08-19',
