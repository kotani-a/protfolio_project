      ...
      workList: [
        {
          ...
          detailedDescription: '某スマホゲームのある要素(召喚獣)を実際の画面に似せて作ったものです。Three.jsを用いて画面を直感的に動かせるのが特徴となってます。また、Next.jsを用いてVercelにデプロイしています。',
          date: '2022-01-22',
        ...
        },
        {
          ...
          detailedDescription: 'このサイトです。Vue.jsを使用して作成しました。スタイル指定方法はscssを使用しております。デプロイはGithub pageを利用しています。レスポンシブ対応もしています。',
          date: '2020-04-19',
        ...
        },
        {
          ...
          detailedDescription: 'GIMPで描いただいぶ前に描いた絵です。意味もなく周り流されapple製品を使っている人たちはネコさんに噛みつかれます。',
          date: '2015-09-01',
